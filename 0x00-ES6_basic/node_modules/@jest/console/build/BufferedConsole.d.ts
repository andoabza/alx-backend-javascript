...
import { ConsoleBuffer, LogMessage, LogType } from '@jest/console/src/types';
export default class BufferedConsole extends Console {
    ...
    static write(buffer: ConsoleBuffer, type: LogType, message: LogMessage, level?: number | null, sourceMaps?: SourceMapRegistry | null): import("@jest/console/src/types").LogEntry[];
    private _log;
    ...
    getBuffer(): import("@jest/console/src/types").LogEntry[] | undefined;
}
